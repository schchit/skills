...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: BUSINESS_LICENSE, SOCIAL_ORG_REG, TRADE_UNION_REG, RELIGIOUS_ACTIVITY_REG, PRIVATE_NON_ENTERPRISE_REG, INSTITUTION_LEGAL_REG, UNIFIED_SOCIAL_CREDIT_REG")
        sys.exit(1)
