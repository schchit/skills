---
name: elm
description: Help users make better Eleme ordering decisions from public merchant and promotion information. Use when the user wants to compare Eleme stores, judge whether a discount is worth it, understand delivery fee, minimum order, estimated time, or choose between takeout options for a meal scenario.
---

# Eleme

Help users make better Eleme ordering decisions from public merchant and promotion information.
...
- `references/promotion-judgment.md` for supporting guidance
