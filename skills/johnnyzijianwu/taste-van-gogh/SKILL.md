...
name: taste-van-gogh
version: 1.0.0
description: Aesthetic skill for AI agents — Van Gogh's Post-Impressionist visual language. Style tokens, anti-tokens, and creative direction distilled from 843 works.
author: InspiredHub
tags: [art, aesthetics, design, van-gogh, post-impressionism, visual-arts, taste]
---
...
**Type:** Artist | **Domain:** Visual Arts | **Era:** Post-Impressionist | **Period:** 1853–1890 | **Origin:** Dutch

**Works in archive:** 843
...
When your AI agent needs to generate or evaluate content in Van Gogh's style, reference these tokens as creative constraints. For example:
...
*Distilled by [InspiredHub](https://inspiredhub.ai) — A sanctuary for artists, aspiring creators, and AI.*
